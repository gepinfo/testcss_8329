...
{check?(<div id="icrvgp" className="cell gpd-clm"  >
                                                        <div id="i6vd27" className="gdp-row gpd-grid"  >
                                                            ...
                                                            <div id="iytw4t" className="cell gpd-clm" >
                                                                <a id="i9imej" className="gpd-text" href="#newscreen" data-toggle="collapse" data-parent="#MainMenu">newscreen <i className="fa fa-caret-down"></i></a>
                                                            </div>
                                                        </div>
                                                    </div>):<></>}
                                                    {check?( <div className="collapse" id="newscreen">
                                                        <div id="icrvgp" className="cell gpd-clm">
                                                            <div id="i6vd27" className="gdp-row gpd-grid">
                                                                <div id="iytw4t" className="cell gpd-clm">
<a id="i9imej" className="gpd-text" href='/first'>first</a>
                                        
<a id="i9imej" className="gpd-text" href='/second'>second</a>
