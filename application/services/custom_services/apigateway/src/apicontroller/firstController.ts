...
export class firstController implements Controller {
    ...
    private initializeRoutes() {
        this.router.post('/first', this.GpCreate);
this.router.get('/first/userid/created_by', this.GpGetNounCreatedBy);
        //#@gepdelimeterone@#
        //#@ssofacebookapiroute@#
        //#@ssogithubapiroute@#
    }
...
public GpCreate(req: Request, res: Response) {
        ...
        new ApiAdapter().post(Constant.NEWSCREENURL + `${req.url}` , req.body)
...
public GpGetNounCreatedBy(req: Request, res: Response) {
        ...
        new ApiAdapter().get(Constant.NEWSCREENURL + `${req.url}` )
        .then((res: any) => res.response.json()).then(result => {
            switch(req.baseUrl) { case '/mobile': res.send(result); break; case '/web': res.send(result); break; default: res.send(null); }
